...
Known issues
----------------
•	The only dependency required tool that may get installed automatically is hdf monkey on Windows, you will need to download, extract & install manually CSpect in the same folder.
